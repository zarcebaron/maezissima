...
<div id="evcal_2" class="postbox evcal_admin_meta">	
	<div class="inside">
		...
		?></select><span class='evoGuideCall'>?<em>You can use this to save upto 2 different languages for customized text. Once saved use the shortcode to show calendar text in that customized language. eg. [add_eventon lang='L2']</em></span></h4>
		...
		<table width='100%'>
			...
			<tr><td colspan='2' id='evcal_lang_days' >
				<div class='full_width_dark evcal_lang_box' style='margin:0 -15px'>
					<?php
