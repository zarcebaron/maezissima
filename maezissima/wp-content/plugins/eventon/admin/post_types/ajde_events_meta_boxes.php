	...
	?>
		<div class='evcal_data_block_style1'>
			...
			<div class='evcal_db_data'>			
				...
				<p><i>(NOTE: Provide either address or latitude longitude(Latlon). If Latlon provided, Latlon will be used for generating google maps while address will be shown as text address. <a href='http://itouchmap.com/latlong.html' target='_blank'>Find LanLat for address</a>)</i></p>
