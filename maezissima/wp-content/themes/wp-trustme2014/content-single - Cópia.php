			  ...
			  <div class="title-block">
				...
				?>
		  		...
		  		<span class="category-item">
		  			<a href="<?php echo esc_url( $category_link ); ?>" title="<?php echo __('Ver todos ('.$category[0]->count.') em ', 'color-theme-framework'); echo $category[0]->cat_name; ?>"><?php echo $category[0]->cat_name; ?></a></span>
				...
				<?php 
					if ( $show_author == true ) :
				?>			
				<span class="meta-author user-ico" <?php if ( $show_date == false ) echo 'style="margin-left: -4px"'; ?>><?php _e('postado por ','color-theme-framework'); echo the_author_link(); ?></span>
				<?php endif; ?>
...
<?php
	...
	if( $post_type == '' ) $post_type = 'standard_post';
			...
			{		
				echo '<div class="rating-stars" style="margin-top: -17px">';	
		  ...
		  <?php endif; ?>
			  ...
			  <?php wp_link_pages(); ?>
                ...
                <div class="fbcomments">
                    <?php echo do_shortcode('[fbcomments url="" width="550" count="off" num="3" url=""]'); ?>
                </div>
