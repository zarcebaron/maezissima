...
?>
    <div id="entry-blog">
	  ...
	  <div class="box-title">
	  	<?php if ( have_posts() ) : ?> 
	  	<!--<h1><?php //printf( __( 'Category Archives: %s', 'color-theme-framework' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h1>-->
        <h1><?php printf( __( '%s', 'color-theme-framework' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h1>
