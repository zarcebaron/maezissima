...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CT 1 Column Vertical Magazine Widget
...
class CT_1Column_Widget extends WP_Widget {
	...
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'ct_1column_widget', 'description' => __( '1 Column Vertical Magazine Widget (show recent posts).' , 'color-theme-framework' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'ct_1column_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'ct_1column_widget', __( 'CT: 1 Column Vertical Magazine Widget' , 'color-theme-framework' ), $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		<?php
			$post_type = get_post_meta(get_the_ID(), 'ct_post_type', true);	
