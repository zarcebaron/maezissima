...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CT 1 Column Criancas
...
add_action('widgets_init', 'CT_1_1column_load_widgets_criancas');

function CT_1_1column_load_widgets_criancas()
{
	register_widget('CT_1_1Column_Widget_criancas');
}
 ...
 *
 */
class CT_1_1Column_Widget_criancas extends WP_Widget {

	/**
	 * Widget setup.
	 */		
	function CT_1_1Column_Widget_criancas()
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'CT_1_1Column_Widget_criancas', 'description' => __( '1 Column Criancas (mostra o que eu quero).' , 'color-theme-framework' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'CT_1_1Column_Widget_criancas' );

		/* Create the widget. */
		$this->WP_Widget( 'CT_1_1Column_Widget_criancas', __( 'CT: 1 Column Criancas' , 'color-theme-framework' ), $widget_ops, $control_ops);
	}
