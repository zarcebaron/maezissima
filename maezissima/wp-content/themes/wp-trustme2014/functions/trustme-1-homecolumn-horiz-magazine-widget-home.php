...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CT 1 Home Column Horizontal  Magazine Widget
...
add_action('widgets_init', 'CT_1_1home_column_load_widgets');

function CT_1_1home_column_load_widgets()
{
	register_widget('CT_1_1home_column_widget');
}
 ...
 *
 */
class CT_1_1home_column_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */		
	function CT_1_1home_column_Widget()
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'ct_1_1home_column_widget', 'description' => __( '1 Home Column Horizontal Magazine Widget (show recent posts).' , 'color-theme-framework' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'ct_1_1home_column_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'ct_1_1home_column_widget', __( 'CT: 1 Home Column Horizontal Magazine Widget' , 'color-theme-framework' ), $widget_ops, $control_ops);
	}
