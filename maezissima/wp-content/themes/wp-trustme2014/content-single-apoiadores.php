	            ...
	            if ( $featured_image_post == 'Show' ) :
	 			...
	 			?>
                    ...
                    if ( in_category( 'Tirinhas' )) {
					  ...
					  <!-- start post thumb -->
				    <div class="single-media-thumb entry-thumb partner">
                    ...
                    <div class="info-partner">
	                    <span><label>Telefone </label><p><?php the_field('telefone'); ?></p></span>
						<span><label>Endereço </label><p><?php the_field('endereco'); ?></p></span>
                        <span><label>Local </label><p><?php the_field('local'); ?></p></span>
                        <span><label>Site </label><p><a href="http://<?php the_field('site'); ?>" target="_blank"><?php the_field('site'); ?></a></p></span>
                        <span><label>Email </label><p><?php the_field('email'); ?></p></span>
                    </div>
