...
define( 'NOTIFIER_THEME_NAME', 'TrustMe' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wp-trustme' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://color-theme.com/tools/notifier/trustme/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
//	$theme_data = get_theme_data(TEMPLATEPATH . '/style.css'); // Read theme current version from the style.css 
	...
	<div class="wrap">
		...
		<div id="instructions">
		    ...
		    <p>Or you can just replace changed files listed below or in the file Changelog.txt.</p>
		</div>
