...
class sidebar_generator {
	...
	function admin_menu(){
		//add_submenu_page('themes.php', __('Custom Sidebars','color-theme-framework'), __('Custom Sidebars','color-theme-framework'), 'manage_options', 'sidebar_generator.php', array('sidebar_generator','admin_page'));
		add_theme_page('Custom Sidebars', __('Custom Sidebars','color-theme-framework'), 'manage_options', 'sidebar_generator.php', array('sidebar_generator','admin_page'));
	}
	...
	function admin_page(){
		...
		<div class="wrap">
			<h2><?php _e('Custom Sidebars','color-theme-framework'); ?></h2>
			<br />
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				...
				<?php
					...
					?>
					<tr>
						<td colspan="3"><?php _e('No Sidebars defined', 'color-theme-framework'); ?></td>
					</tr>
					<?php
				}
				?>
	...
	*/
	...
	<div id='sbg-sortables' class='meta-box-sortables'>
		<div id="sbg_box" class="postbox " >
			<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span><?php _e( 'Custom Sidebars' , 'color-theme-framework' ); ?></span></h3>
			<div class="inside">
				<div class="sbg_container">
					<input name="sbg_edit" type="hidden" value="sbg_edit" />
					
					<p>
	<?php _e('Select the custom sidebar, leave unselected to use the default sidebar', 'color-theme-framework'); ?>
					</p>
					<ul>
					<?php 
