...
?>
    <div id="entry-blog">
	  ...
	  <div class="box-title">
	  	<?php if ( !have_posts() ) { echo '<h1>Sem resultados :(</h1>'; } else { ?>			
					<h1><?php _e( 'Resultados para' , 'color-theme-framework' ); ?> "<?php echo get_search_query(); ?>"</h1>
					<div class="clear"></div>
	  ...
	  <?php 
		if ( !have_posts() ) { 		  
	  ?>
	  <p><?php _e( '<h4>Que pena! Sua busca não retornou nenhum resultado. Tente buscar utilizando outras palavras.</h4>', 'color-theme-framework' ); ?></p>
      				<div class="srp">
					<?php get_search_form(); ?>
                    </div>
				<?php } ?>	
