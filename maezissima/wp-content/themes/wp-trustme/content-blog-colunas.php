...
// Categories "colunas" in production

		query_posts( array( 'post_type' => 'post', 'paged' => $paged, 'category__in' => array('4','5','6','7','8','9','10','11') ) );
	...
	<div class="<?php if (has_post_thumbnail() || ( !has_post_thumbnail() && has_post_format('video') || has_post_format('gallery')) ) echo 'span8'; else echo 'span12'; ?>" <?php if ( $blog_type == 'Chessboard' ) { if( $left_right%2 == 0 ) { echo 'style="float: left; margin-left: 0"'; }} ?>>
				  ...
				  <div class="title-block <?php if ( ( $show_date == false ) and ( $show_author == false ) ) echo 'no-bottom-mp';?>">
					...
					*/?>
			  		...
			  		<!--<span class="category-item"><a href="<?php //echo esc_url( $category_link ); ?>" title="<?php //echo __('View all posts in ', 'color-theme-framework'); echo $category[0]->cat_name; ?>"><?php //echo $category[0]->cat_name; ?></a></span>-->
                    <?php
