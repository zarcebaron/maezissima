...
class CT_2Columns_Widget extends WP_Widget {
	...
	function CT_2Columns_Widget()
	{
		...
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'ct_2columns_widget' );
		
		/* Create the widget. */
		$this->WP_Widget( 'ct_2columns_widget', __( 'CT: 2 Columns Magazine Widget' , 'color-theme-framework' ), $widget_ops, $control_ops);
	}
...
?>
	...
	{
		$defaults = array( 'title' => __( 'First Column' , 'color-theme-framework' ) , 'categories' => 'all', 'posts' => 4, 'show_image'=> 'on', 'show_category'=> 'on', 'show_date'=> 'on', 'show_comments'=> 'on', 'show_excerpt'=> 'on');
