    ...
    <div id="entry-blog">
	  ...
	  <div class="box-title">
	  	<?php if ( have_posts() ) : ?>			
				<h1><?php
					if ( is_day() ) :
						printf( __( 'Arquivos do dia: %s', 'color-theme-framework' ), '<span>' . get_the_date() . '</span>' );
					elseif ( is_month() ) :
						printf( __( 'Arquivos do mês: %s', 'color-theme-framework' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'color-theme-framework' ) ) . '</span>' );
					elseif ( is_year() ) :
						printf( __( 'Arquivos do ano: %s', 'color-theme-framework' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'color-theme-framework' ) ) . '</span>' );
					else :
