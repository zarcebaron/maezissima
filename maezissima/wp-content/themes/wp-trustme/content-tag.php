<?php
/*
	 * The template for displaying content in the tag.php template
...
?>
    <div id="entry-blog">
	  ...
	  <div class="box-title">
	  	<?php if ( have_posts() ) : ?>			
				<h1><?php printf( __( 'Arquivo da Tag: %s', 'color-theme-framework' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></h1>
			<?php if ( tag_description() ) : // Show an optional category description ?>
				<h2><?php echo tag_description(); ?></h2>
			<?php endif; ?>	  	
...
<?php
	...
	<div class="<?php if (has_post_thumbnail() || ( !has_post_thumbnail() && has_post_format('video') || has_post_format('gallery')) ) echo 'span6'; else echo 'span12'; ?>" <?php if ( $blog_type == 'Chessboard' ) { if( $left_right%2 == 0 ) { echo 'style="float: left; margin-left: 0"'; }} ?>>
